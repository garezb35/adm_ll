            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        @break
                        @case('kr')
                         <img src="{{ URL::asset('build/images/flags/kr.svg') }}" class="rounded" alt="Header Language" height="20">
                        @break
                        @default
                        <img src="{{ URL::asset('build/images/flags/kr.svg') }}" class="rounded" alt="Header Language" height="20">
                        @endswitch
                    ...
                    <div class="dropdown-menu dropdown-menu-end">
                        ...
                        <a href="{{ url('index/kr') }}" class="dropdown-item notify-item language py-2" data-lang="kr" title="Korean">
                            <img src="{{ URL::asset('build/images/flags/kr.svg') }}" alt="user-image" class="me-2 rounded" height="20">
                    ...
                    <button type="button" class="btn shadow-none" id="page-header-user-dropdown" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                <span class="d-none d-xl-inline-block ms-1 fw-medium user-name-text">{{$user->userid}}</span>
                            </span>
                        </span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-end">
