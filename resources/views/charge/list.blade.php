                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="req_type" class="form-select" data-choices id="req_type">
                                ...
                                <option value="1" @if ($req_type == "1") selected @endif>회원 환충</option>
                                <option value="2" @if ($req_type == "2") selected @endif>관리자</option>
                                <option value="4" @if ($req_type == "4") selected @endif>관리자 환충</option>
                                <option value="5" @if ($req_type == "5") selected @endif>루징 전환</option>
                                <option value="8" @if ($req_type == "8") selected @endif>매장-하부</option>
                                <option value="6" @if ($req_type == "6") selected @endif>매장처리</option>
                            </select>
                        </div>
                        <div class="col-md-2">
                    ...
                    <div class="row mb-3">
                        <div class="col-md-4">
                            <blockquote class="blockquote custom-blockquote blockquote-danger rounded mb-0"
                                        style="padding: 8px">
                                <p>총액 {{number_format($nSumCharge)}}</p>
                            </blockquote>
                        </div>
                        <div class="col-md-2">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="table-responsive" id="data-tables-part">
                            @include('charge.table', ['sort' => $sort, 'type' => $type, 'chargeRecord' => $chargeRecord])
                        </div>
                    </div>
                </div>
            </div>
