                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center gap-1">
                                        <div class="flex-shrink-0">
                                            <img src="build/images/users/avatar-4.jpg" alt="" class="avatar-sm rounded-circle p-1">
                                        </div>
                                        <div class="flex-grow-1">
                    ...
                    <div class="vstack gap-2">
                            ...
                            <div class="d-flex align-items-center gap-2">
                                <div class="avatar-sm flex-shrink-0">
                                    <div class="avatar-title bg-light rounded">
                                        <img src="build/images/products/img-1.png" alt="" class="avatar-xs">
                                    </div>
                                </div>
                                <div class="flex-grow-1">
                                    <a href="#!">
                        ...
                        <div class="p-2 border border-dashed">
                            <div class="d-flex align-items-center gap-2">
                                <div class="avatar-sm flex-shrink-0">
                                    <div class="avatar-title bg-light rounded">
                                        <img src="build/images/products/img-2.png" alt="" class="avatar-xs">
                                    </div>
                                </div>
                                <div class="flex-grow-1">
                                    <a href="#!">
                        ...
                        <div class="p-2 border border-dashed">
                            <div class="d-flex align-items-center gap-2">
                                <div class="avatar-sm flex-shrink-0">
                                    <div class="avatar-title bg-light rounded">
                                        <img src="build/images/products/img-3.png" alt="" class="avatar-xs">
                                    </div>
                                </div>
                                <div class="flex-grow-1">
                                    <a href="#!">
                        ...
                        <div class="p-2 border border-dashed">
                            <div class="d-flex align-items-center gap-2">
                                <div class="avatar-sm flex-shrink-0">
                                    <div class="avatar-title bg-light rounded">
                                        <img src="build/images/products/img-4.png" alt="" class="avatar-xs">
                                    </div>
                                </div>
                                <div class="flex-grow-1">
                                    <a href="#!">
                        ...
                        <div class="p-2 border border-dashed">
                            <div class="d-flex align-items-center gap-2">
                                <div class="avatar-sm flex-shrink-0">
                                    <div class="avatar-title bg-light rounded">
                                        <img src="build/images/products/img-5.png" alt="" class="avatar-xs">
                                    </div>
                                </div>
                                <div class="flex-grow-1">
                                    <a href="#!">
                        ...
                        <div class="p-2 border border-dashed">
                            <div class="d-flex align-items-center gap-2">
                                <div class="avatar-sm flex-shrink-0">
                                    <div class="avatar-title bg-light rounded">
                                        <img src="build/images/products/img-6.png" alt="" class="avatar-xs">
                                    </div>
                                </div>
                                <div class="flex-grow-1">
                                    <a href="#!">
                ...
                <div class="row g-0">
                    <div class="col-lg-5">
                        <div class="bg-primary-subtle p-5 h-100">
                            <div class="p-lg-4">
                                <img src="build/images/products/img-3.png" alt="" class="img-fluid">
                            </div>
                        </div>
                    </div>
                    <!--end col-->
