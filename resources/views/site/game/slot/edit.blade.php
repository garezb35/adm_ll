...
<div class="card">
    ...
    <div class="card-body">
        ...
        <div class="row mb-3">
            <div class="col-12">
                @include('site.game.slot.nav', ['game_id' => $game_id, 'type' => 'edit'])
            </div>
        </div>
        <form action="" id="IndivGameEditForm" method="post" accept-charset="utf-8">
            ...
            <div class="row mb-3">
                ...
                <div class="col-2">
                    ...
                    <input type="number" id="IndivGameOrder" name="order" value="{{$gameinfo->order_no}}" class="form-control"/>
            ...
            <div class="row">
                <div class="col-12">
                    ...
                    <a onclick="javascript:popupCenter('{{route('gameslogs')}}?gameid={{$game_id}}&gametype={{$game_type}}', '', 800, 600);" href="#" class="btn btn-outline-primary JQ_POPUP">수정로그</a>
                </div>
            </div>
        </form>
    </div>
