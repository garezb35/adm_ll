...
@section('content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="" novalidate="novalidate" autocomplete="off" id="UserDepthNameAddForm" method="post"
                  accept-charset="utf-8">
                @csrf
                <div class="row mb-3">
                    <div class="col-12">
                        <label for="UserDepthNameName" class="form-label">단계명</label>
                        <input name="step_name" maxlength="50" type="text" value="{{$step_name}}" id="UserDepthNameName"
