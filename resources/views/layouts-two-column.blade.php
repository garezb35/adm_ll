                        ...
                        <div class="card">
                            <div class="card-header d-flex align-items-center">
                                ...
                                <div class="flex-shrink-0">
                                    <a href="apps-learning-category.html" class="icon-link icon-link-hover">View All <i class="bi bi-arrow-right"></i></a>
                                </div>
                            </div>
                            <div class="card-body">
                                <div class="row g-4">
                                        ...
                                        <div class="text-center">
                                            <div class="avatar-sm mx-auto">
                                                <div class="avatar-title bg-success-subtle rounded">
                                                    <img src="build/images/learning/shopify.png" alt="" class="avatar-xs">
                                                </div>
                                            </div>
                                            <h6 class="text-trucate mb-0 mt-3"><a href="apps-learning-grid.html" class="text-reset">Shopify Development</a></h6>
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-3 col-sm-6">
                                        <div class="text-center">
                                            <div class="avatar-sm mx-auto">
                                                <div class="avatar-title bg-info-subtle rounded">
                                                    <img src="build/images/learning/webpack.png" alt="" class="avatar-xs">
                                                </div>
                                            </div>
                                            <h6 class="text-trucate mb-0 mt-3"><a href="apps-learning-grid.html" class="text-reset">Marketing & Management</a></h6>
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-3 col-sm-6">
                                        <div class="text-center">
                                            <div class="avatar-sm mx-auto">
                                                <div class="avatar-title bg-danger-subtle rounded">
                                                    <img src="build/images/learning/laravel.png" alt="" class="avatar-xs">
                                                </div>
                                            </div>
                                            <h6 class="text-trucate mb-0 mt-3"><a href="apps-learning-grid.html" class="text-reset">Laravel Development</a></h6>
                                        </div>
                                    </div>
                                    <!--end col-->
                                    <div class="col-lg-3 col-sm-6">
                                        <div class="text-center">
                                            <div class="avatar-sm mx-auto">
                                                <div class="avatar-title bg-info-subtle rounded">
                                                    <img src="build/images/learning/react.png" alt="" class="avatar-xs">
                                                </div>
                                            </div>
                                            <h6 class="text-trucate mb-0 mt-3"><a href="apps-learning-grid.html" class="text-reset">React Development</a></h6>
                                        </div>
                                    </div>
                                    <!--end col-->
                                </div>
            ...
            <div class="col-lg-4">
                <div class="card card-height-100">
                    <div class="card-header d-flex align-items-center">
                        ...
                        <div class="flex-shrink-0">
                            <a href="apps-instructors-list.html" class="icon-link icon-link-hover">View All <i class="bi bi-arrow-right"></i></a>
                        </div>
                    </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center gap-1">
                                                    <div class="flex-shrink-0">
                                                        <img src="build/images/users/48/avatar-2.jpg" alt="" class="avatar-sm rounded-circle p-1">
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <h6 class="fs-md mb-1"><a href="apps-instructors-overview.html" class="text-reset">Bethany Nienow</a></h6>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center gap-1">
                                                    <div class="flex-shrink-0">
                                                        <img src="build/images/users/48/avatar-7.jpg" alt="" class="avatar-sm rounded-circle p-1">
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <h6 class="fs-md mb-1"><a href="apps-instructors-overview.html" class="text-reset">Sonia Conn</a></h6>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center gap-1">
                                                    <div class="flex-shrink-0">
                                                        <img src="build/images/users/48/avatar-4.jpg" alt="" class="avatar-sm rounded-circle p-1">
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <h6 class="fs-md mb-1"><a href="apps-instructors-overview.html" class="text-reset">Talon Bradtke</a></h6>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center gap-1">
                                                    <div class="flex-shrink-0">
                                                        <img src="build/images/users/48/avatar-5.jpg" alt="" class="avatar-sm rounded-circle p-1">
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <h6 class="fs-md mb-1"><a href="apps-instructors-overview.html" class="text-reset">Tyrell Kerluke</a></h6>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center gap-1">
                                                    <div class="flex-shrink-0">
                                                        <img src="build/images/users/48/avatar-6.jpg" alt="" class="avatar-sm rounded-circle p-1">
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <h6 class="fs-md mb-1"><a href="apps-instructors-overview.html" class="text-reset">Ross Zieme</a></h6>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center gap-1">
                                                    <div class="flex-shrink-0">
                                                        <img src="build/images/users/48/avatar-1.jpg" alt="" class="avatar-sm rounded-circle p-1">
                                                    </div>
                                                    <div class="flex-grow-1">
                                                        <h6 class="fs-md mb-1"><a href="apps-instructors-overview.html" class="text-reset">Hollis Spencer</a></h6>
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center gap-1">
                                                    <div class="flex-shrink-0">
                                                        <img src="build/images/users/48/avatar-8.jpg" alt="" class="avatar-sm rounded-circle p-1">
                                                    </div>
                                                    <div class="flex-grow-1">
                        ...
                        <tbody class="list">
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="build/images/learning/react.png" alt="react.png" class="avatar-xxs rounded"> <a href="apps-learning-overview.html" class="text-reset courses_Name">Advanced React and Redux</a>
                                    </div>
                                </td>
                                <td class="category">
                                    React Development
                            ...
                            <tr>
                                <td class="courses_Name">
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="build/images/learning/shopify.png" alt="shopify.png" class="avatar-xxs rounded"> <a href="apps-learning-overview.html" class="text-reset">The Complete Shopify Dropship course</a>
                                    </div>
                                </td>
                                <td class="category">
                                    Shopify Development
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="build/images/learning/sketch.png" alt="sketch.png" class="avatar-xxs rounded"> <a href="apps-learning-overview.html" class="text-reset courses_Name">UI/UX Style guide With Sketch</a>
                                    </div>
                                </td>
                                <td class="category">
                                    Graphic Design
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="build/images/learning/webpack.png" alt="webpack.png" class="avatar-xxs rounded"> <a href="apps-learning-overview.html" class="text-reset courses_Name">Digital Marketing</a>
                                    </div>
                                </td>
                                <td class="category">
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="build/images/learning/laravel.png" alt="laravel.png" class="avatar-xxs rounded courses_Name"> <a href="apps-learning-overview.html" class="text-reset">Master Laravel for Beginners &amp; Intermediate</a>
                                    </div>
                                </td>
                                <td class="category">
                                    Laravel Development
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-center gap-2">
                                        <img src="build/images/learning/tailwindcss.png" alt="" class="avatar-xxs rounded courses_Name"> <a href="apps-learning-overview.html" class="text-reset">Tailwind CSS From Scratch</a>
                                    </div>
                                </td>
                                <td class="category">
                                    Web Design
        ...
        <div class="card card-height-100">
            <div class="card-body">
                ...
                <div class="text-center mb-4 pb-2">
                    <img src="build/images/users/avatar-3.jpg" alt="" class="avatar-md rounded-circle">
                    <h6 class="fs-md mt-3 mb-1"><a href="pages-profile.html" class="text-reset">Richard Marshall <i class="bi bi-patch-check-fill text-info"></i></a></h6>
                ...
                <div class="mt-4">
                    ...
                    <div class="card border-start border-primary border-3">
                        <div class="card-body">
                            <A href="apps-learning-overview.html" class="btn btn-primary btn-icon btn-sm float-end"><i class="bi bi-arrow-right"></i></A>
                ...
                <div class="card bg-primary overflow-hidden mb-0">
                    <div class="position-absolute bottom-0" style="opacity: 0.15;">
                        <img src="build/images/effect-pattern/pattern-2.svg" alt="" class="img-fluid">
                    </div>
